...
public class Enemy2 extends AnimatedSprite{
  ...
  public Enemy2(PImage img, float scale, float bLeft, float bRight){
    super(img, scale);
    moveLeft = new PImage[2];
    moveLeft[0] = loadImage("bee_walk_left1.png");
    moveLeft[1] = loadImage("bee_walk_left2.png");
    moveRight = new PImage[2];
    moveRight[0] = loadImage("bee_walk_right1.png");
    moveRight[1] = loadImage("bee_walk_right2.png"); 
